  ...
  return (
    <div className="mystyla-auth-shell flex w-full min-h-screen items-center justify-center px-4 py-8">
      <div className="relative w-full max-w-md">
        ...
        <Card className="mystyla-auth-card w-full border-0">
          <CardContent className="space-y-6 p-7 sm:p-8">
            <div className="text-center space-y-2">
              <h1 className="mystyla-masthead text-[11px] font-semibold text-[#8e7c75]">Login</h1>
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs font-medium text-[#4f9d96] hover:underline"
                  >
                    Forgot password?
                  </button>
                </div>
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-[#8a7a72]">
              <span className="h-px w-10 bg-[#e7d8d0]" />
        ...
        <div className="mt-5 text-center text-sm text-[#786962]">
          Don&apos;t have an account?{' '}
          <button
            type="button"
            onClick={() => onNavigate('register')}
            className="font-semibold text-[#4f9d96] hover:underline"
          >
            Sign Up
          </button>
        </div>
